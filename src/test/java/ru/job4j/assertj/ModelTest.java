...
class ModelTest {
    @Test
    void checkBoolean() {
        Model model = new Model(1, 5.255d, "testName", true);
        boolean result = model.isCondition();
        assertThat(result).isTrue();
    }
    @Test
    void checkStringChain() {
        Model model = new Model(1, 5.255d, "Am I learning Java?", true);
        ...
        assertThat(result).isNotNull()
                ...
                .startsWith("Am I")
                .startsWithIgnoringCase("am")
                .endsWith("?")
                .isEqualTo("Am I learning Java?");
    }
    @Test
    void checkInt() {
